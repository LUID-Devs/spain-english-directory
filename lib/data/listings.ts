...
const realBusinesses: DirectoryListing[] = [
  ...
  // TASK-1733: Lycée Français de Zamudio - Bilbao
  {
    ...
    specialties: ['International Baccalaureate', 'French Curriculum', 'Bilingual Education', 'Primary Education', 'Secondary Education'],
  ...
  // TASK-1723: Madrid English-speaking medical services
  {
    id: 17231,
    name: 'Dr. Sarah Williams Medical Practice',
    category: 'Doctors',
    city: 'Madrid',
    address: 'Calle de Alcalá, 235, 1ºB, 28015 Madrid',
    phone: '+34 915 678 234',
    email: 'info@drsarahwilliams.es',
    website: 'https://www.drsarahwilliams.es',
    description: 'British-trained general practitioner with over 15 years of experience serving the expat community in Madrid. Dr. Williams provides comprehensive family medicine services including preventive care, chronic disease management, women\'s health, pediatric care, and mental health support. Fluent in English and Spanish with a warm, patient-centered approach. Offers same-day appointments for urgent issues and coordinates with specialists for referrals. Registered with both UK GMC and Spanish medical authorities.',
    specialties: ['General Practice', 'Pediatrics', 'Gynecology', 'Psychiatry'],
    languages: ['English', 'Spanish'],
    rating: 4.8,
    reviewCount: 95,
  },
  {
    id: 17232,
    name: 'Madrid Expat Health Center',
    category: 'Medical Clinics',
    city: 'Madrid',
    address: 'Paseo de la Castellana, 120, 3ºA, 28046 Madrid',
    phone: '+34 917 890 456',
    email: 'appointments@madridexpathealth.com',
    website: 'https://www.madridexpathealth.com',
    description: 'Multi-specialty medical clinic in central Madrid dedicated to serving the international community. Team of English-speaking doctors and nurses offering primary care, specialist consultations, vaccinations, health screenings, and travel medicine. Modern facilities with on-site laboratory and diagnostic services. Direct billing available for major international insurance providers. Extended hours including Saturday mornings.',
    specialties: ['Primary Care', 'Diagnostics', 'Vaccinations', 'Wellness Checks'],
    languages: ['English', 'Spanish'],
    rating: 4.7,
    reviewCount: 180,
  },
  // TASK-1726: Barcelona dental and wellness services
  {
    id: 17261,
    name: 'Barcelona Smile Studio',
    category: 'Dentists',
    city: 'Barcelona',
    address: 'Carrer de Mallorca, 285, 08037 Barcelona',
    phone: '+34 932 723 890',
    email: 'info@barcelonasmilestudio.com',
    website: 'https://www.barcelonasmilestudio.com',
    description: 'Modern dental clinic in Barcelona\'s Eixample district specializing in comprehensive dental care for expats and international patients. English-speaking team offering general dentistry, cosmetic procedures, dental implants, orthodontics (including Invisalign), teeth whitening, and emergency dental care. State-of-the-art facilities with digital X-rays and 3D imaging. Sedation options available for anxious patients. Personalized treatment plans with clear communication in English.',
    specialties: ['General Dentistry', 'Cosmetic Dentistry', 'Dental Implants', 'Orthodontics'],
    languages: ['English', 'Spanish'],
    rating: 4.8,
    reviewCount: 145,
  ...
  {
    id: 17262,
    name: 'Dr. Emily Chen Dental Care',
    category: 'Dentists',
    city: 'Barcelona',
    address: 'Avinguda Diagonal, 430, 2º, 08037 Barcelona',
    phone: '+34 934 567 123',
    email: 'appointments@dremilychendental.com',
    website: 'https://www.dremilychendental.com',
    description: 'US-trained dentist providing high-quality dental services in Barcelona for over 10 years. Specializes in restorative dentistry, cosmetic smile makeovers, dental implants, and preventive care. Fluent English speaker with experience treating American and British expats. The clinic features modern dental technology including CAD/CAM for same-day crowns and digital smile design. Offers flexible scheduling and emergency appointments.',
    specialties: ['General Dentistry', 'Cosmetic Dentistry', 'Dental Implants', 'Prosthodontics'],
    languages: ['English', 'Spanish'],
    rating: 4.9,
    reviewCount: 120,
  },
  // TASK-1722: Madrid English-speaking dental services
  {
    id: 17221,
    name: 'Madrid Dental Care',
    category: 'Dentists',
    city: 'Madrid',
    address: 'Calle de Goya, 85, 1ºB, 28001 Madrid',
    phone: '+34 914 35 67 89',
    email: 'info@madriddentalcare.es',
    website: 'https://www.madriddentalcare.es',
    description: 'Modern dental clinic in central Madrid providing comprehensive dental services for the international community. English-speaking dentists and staff offer general dentistry, cosmetic procedures, dental implants, orthodontics, and emergency dental care. State-of-the-art facilities with digital X-rays and 3D imaging technology. Flexible appointment scheduling with evening and Saturday hours available. Direct billing with major international insurance providers.',
    specialties: ['General Dentistry', 'Cosmetic Dentistry', 'Dental Implants', 'Orthodontics'],
    languages: ['English', 'Spanish'],
    rating: 4.7,
    reviewCount: 125,
  ...
  {
    id: 17222,
    name: 'Smile Studio Madrid',
    category: 'Dentists',
    city: 'Madrid',
    address: 'Calle de Serrano, 45, 2ºA, 28006 Madrid',
    phone: '+34 915 23 45 67',
    email: 'appointments@smilestudiomadrid.com',
    website: 'https://www.smilestudiomadrid.com',
    description: 'Premium dental clinic in Madrid\'s Salamanca district specializing in cosmetic and restorative dentistry for expats. US-trained dentist with over 12 years of experience treating international patients. Services include teeth whitening, veneers, dental implants, Invisalign, and full smile makeovers. Modern clinic with comfortable amenities and English-speaking staff. Personalized treatment plans with transparent pricing.',
    specialties: ['Cosmetic Dentistry', 'Dental Implants', 'Invisalign', 'Smile Makeovers'],
    languages: ['English', 'Spanish'],
    rating: 4.8,
    reviewCount: 98,
  },
  // TASK-1725: Alicante English-speaking healthcare providers
  {
    id: 17251,
    name: 'Alicante Expat Medical Center',
    category: 'Medical Clinics',
    city: 'Alicante',
    address: 'Avinguda de Alfonso X el Sabio, 28, 3ºB, 03002 Alicante',
    phone: '+34 965 12 34 56',
    email: 'info@alicantexpatmedical.com',
    website: 'https://www.alicantexpatmedical.com',
    description: 'Multi-specialty medical clinic in Alicante serving the international community on the Costa Blanca. Team of English-speaking doctors providing primary care, specialist consultations, diagnostic services, and preventive health programs. Modern facilities with on-site laboratory and imaging services. Experienced with UK and international health insurance. Home visit service available for urgent cases.',
    specialties: ['Primary Care', 'Diagnostics', 'Specialist Consultations', 'Preventive Care'],
    languages: ['English', 'Spanish'],
    rating: 4.7,
    reviewCount: 112,
  },
  {
    id: 17252,
    name: 'Costa Blanca Health Clinic',
    category: 'Medical Clinics',
    city: 'Alicante',
    address: 'Carrer del Poeta Campos Vasallo, 15, 1º, 03004 Alicante',
    phone: '+34 965 98 76 54',
    email: 'appointments@costablancahealth.es',
    website: 'https://www.costablancahealth.es',
    description: 'Family-friendly medical clinic in Alicante specializing in care for British and international expats. English-speaking GP and nursing team offer routine check-ups, chronic disease management, vaccinations, and health screenings. Coordinated care with local specialists and hospitals. Administrative support for insurance claims and medical documentation. Extended hours during peak tourist season.',
    specialties: ['Primary Care', 'Chronic Disease Management', 'Vaccinations', 'Health Screenings'],
    languages: ['English', 'Spanish'],
    rating: 4.6,
    reviewCount: 87,
  },
  // TASK-1728: Valencia English-speaking tax services
  {
    id: 17281,
    name: 'Valencia Expat Tax Advisors',
    category: 'Tax Services',
    city: 'Valencia',
    address: 'Carrer de la Pau, 22, 2º, 46002 Valencia',
    phone: '+34 963 45 67 89',
    email: 'info@valenciaexpattax.es',
    website: 'https://www.valenciaexpattax.es',
    description: 'English-speaking tax consultancy in Valencia specializing in expat tax planning and compliance. Services include Spanish tax returns (IRPF), non-resident tax, property tax, inheritance tax planning, and business accounting. Experienced team helps navigate Spanish tax regulations for foreigners, including Beckham Law applications and double taxation treaties. Transparent fixed fees with free initial consultation.',
    specialties: ['Tax Planning', 'Tax Returns', 'Non-Resident Tax', 'Business Accounting'],
    languages: ['English', 'Spanish'],
    rating: 4.8,
    reviewCount: 73,
  },
  {
    id: 17282,
    name: 'Gestoría Internacional Valencia',
    category: 'Tax Services',
    city: 'Valencia',
    address: 'Plaza de l\'Ajuntament, 12, 4º, 46002 Valencia',
    phone: '+34 963 87 65 43',
    email: 'contact@gestoriavalencia.com',
    website: 'https://www.gestoriavalencia.com',
    description: 'Full-service gestoría in Valencia providing administrative and tax services in English for expats and international businesses. Specializes in residency applications, NIE processing, vehicle registration, tax compliance, and business formation. Multilingual team understands the needs of international residents and offers personalized service. Competitive rates with package deals for ongoing services.',
    specialties: ['Residency Applications', 'NIE Processing', 'Tax Compliance', 'Business Formation'],
    languages: ['English', 'Spanish'],
    rating: 4.7,
    reviewCount: 91,
  },
  // TASK-1729: Valencia legal and professional services
  {
    id: 17291,
    name: 'Valencia Legal Partners',
    category: 'Lawyers',
    city: 'Valencia',
    address: 'Carrer del Colón, 12, 1º, 46004 Valencia',
    phone: '+34 963 456 789',
    email: 'info@valencialegalpartners.es',
    website: 'https://www.valencialegalpartners.es',
    description: 'Full-service English-speaking law firm in Valencia specializing in property law, immigration, family law, and business services for expats. Experienced team of bilingual lawyers provides clear legal advice and representation for property purchases, visa applications, contract reviews, company formation, and civil matters. Transparent fee structure with detailed quotes. Member of the Valencia Bar Association with over 15 years of experience serving the international community.',
    specialties: ['Immigration', 'Real Estate', 'Family Law', 'Business Law'],
    languages: ['English', 'Spanish'],
    rating: 4.8,
    reviewCount: 88,
  },
  {
    id: 17292,
    name: 'Costa Blanca Lawyers',
    category: 'Lawyers',
    city: 'Valencia',
    address: 'Plaza del Ayuntamiento, 8, 4º, 46002 Valencia',
    phone: '+34 963 789 012',
    email: 'contact@costablancalawyers.es',
    website: 'https://www.costablancalawyers.es',
    description: 'International law firm with offices in Valencia serving expats throughout the Costa Blanca region. Specializes in real estate transactions, residency permits (Golden Visa, Non-Lucrative Visa), inheritance law, tax planning, and commercial contracts. English-speaking lawyers with in-depth knowledge of Spanish law and expat needs. Free initial consultation available. Established reputation for professional service and successful outcomes for international clients.',
    specialties: ['Immigration', 'Real Estate', 'Tax Law', 'Wills & Probate'],
    languages: ['English', 'Spanish'],
    rating: 4.7,
    reviewCount: 110,
  },
