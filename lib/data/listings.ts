...
const realBusinesses: DirectoryListing[] = [
  ...
  // TASK-1652: Simple English Advice - Gestor/Consultancy - Malaga
  {
    ...
    category: 'Gestors',
    city: 'Malaga',
    address: 'Calle Cortina del Muelle 13, 4º, 29015 Málaga',
    phone: '+34 951 74 51 68',
    email: 'info@simpleenglishadvice.com',
    website: 'https://simpleenglishadvice.com',
    description: 'Award-winning English-speaking gestoría and consultancy based in Málaga, serving the Costa del Sol and all of Spain. Specializing in helping expats and international residents navigate Spanish bureaucracy with ease. Winner of the SME News Award for Best Expat Relocation Support Service. Services include vehicle transfers and registration, UK driving licence exchange for Spanish licence, NRA rental registration for landlords, EU vehicle import and matriculation, autónomo registration and ongoing tax filing, digital certificate applications, visa and residency support including Digital Nomad Visa, property registration assistance, and general bureaucracy support. Clear communication in English with transparent pricing and a patient, understanding approach to complex administrative processes. Remote services available for clients throughout Spain.',
    specialties: ['Vehicle Transfers', 'Driving Licence Exchange', 'NRA Registration', 'Vehicle Import', 'Autónomo Registration', 'Tax Filing', 'Digital Certificates', 'Visa Applications'],
  ...
  // TASK-1694: Emergency Dental Clinics - Barcelona & Madrid
  {
    id: 16941,
    name: 'Dental Emergency Barcelona',
    category: 'Dentists',
    city: 'Barcelona',
    address: 'Carrer de València, 288, 08007 Barcelona',
    phone: '+34 932 688 900',
    email: 'info@dentalemergencybcn.com',
    website: 'https://www.dentalemergencybcn.com',
    description: '24-hour emergency dental clinic in central Barcelona specializing in urgent dental care for tourists and residents. English-speaking dentists available around the clock for toothaches, broken teeth, lost fillings, and dental trauma. Immediate pain relief and temporary repairs. Direct billing to travel insurance.',
    specialties: ['Emergency Dentistry', 'Toothache Relief', 'Dental Trauma', 'Root Canal'],
    languages: ['English', 'Spanish', 'Catalan'],
    rating: 4.8,
    reviewCount: 95,
  },
  {
    ...
    city: 'Barcelona',
    address: 'Carrer de Balmes, 152, 08008 Barcelona',
    phone: '+34 934 567 234',
    email: 'urgencias@dentalbcn.es',
    website: 'https://www.urgenciasdentalbcn.es',
    description: 'Same-day emergency dental appointments in Barcelona. Specialist in weekend and evening dental emergencies. English-speaking staff with experience treating international patients. Services include emergency extractions, temporary crowns, and pain management.',
    specialties: ['Emergency Dentistry', 'Weekend Dental Care', 'Pain Management', 'Extractions'],
    languages: ['English', 'Spanish', 'French'],
    rating: 4.7,
    reviewCount: 78,
  },
  {
    id: 16943,
    name: 'Centre Dental Roca',
    category: 'Dentists',
    city: 'Barcelona',
    address: 'Passeig de Gràcia, 45, 08007 Barcelona',
    phone: '+34 931 876 543',
    email: 'info@centredentalroca.com',
    website: 'https://www.centredentalroca.com',
    description: 'Family dental clinic in central Barcelona offering emergency appointments and comprehensive dental care. English-speaking dentists with over 20 years experience. Modern facilities with digital X-ray and same-day emergency treatment.',
    specialties: ['General Dentistry', 'Emergency Care', 'Cosmetic Dentistry', 'Implants'],
    languages: ['English', 'Spanish', 'Catalan'],
    rating: 4.9,
    reviewCount: 124,
  },
  {
    id: 16944,
    name: 'The British Dental Clinic Barcelona',
    category: 'Dentists',
    city: 'Barcelona',
    address: 'Carrer de Muntaner, 180, 08036 Barcelona',
    phone: '+34 936 789 012',
    email: 'appointments@britishdentalbcn.com',
    website: 'https://www.britishdentalbcn.com',
    description: 'UK-trained dentists providing emergency and routine dental care in Barcelona. Fully English-speaking team specializing in treating British and American expats. Emergency same-day appointments available. Nervous patient care specialists.',
    specialties: ['Emergency Dentistry', 'Cosmetic Dentistry', 'Nervous Patients', 'Implants'],
    languages: ['English', 'Spanish'],
    rating: 4.8,
    reviewCount: 156,
  },
  {
    ...
    category: 'Dentists',
    city: 'Madrid',
    address: 'Calle de Goya, 45, 28001 Madrid',
    phone: '+34 915 765 432',
    email: 'emergency@dentistmadrid.com',
    website: 'https://www.emergencydentistmadrid.com',
    description: 'Same-day emergency dental appointments in central Madrid. English-speaking dental team providing urgent care for toothaches, broken teeth, and dental infections. Open 7 days a week with extended hours. Walk-ins welcome.',
    specialties: ['Emergency Dentistry', 'Root Canal', 'Extractions', 'Dental Infections'],
    languages: ['English', 'Spanish'],
    rating: 4.7,
    reviewCount: 89,
  },
  {
    id: 16952,
    name: 'Clínica Dental Urgencias Madrid',
    category: 'Dentists',
    city: 'Madrid',
    address: 'Calle de Alcalá, 256, 28027 Madrid',
    phone: '+34 917 234 567',
    email: 'urgencias@clinicadentalmadrid.es',
    website: 'https://www.clinicadentalmadrid.es',
    description: '24-hour emergency dental clinic in Madrid providing round-the-clock care for dental emergencies. Fully equipped for immediate treatment of dental trauma, severe pain, and infections. English-speaking dentists and staff.',
    specialties: ['24h Emergency Care', 'Dental Trauma', 'Severe Pain', 'Infections'],
    languages: ['English', 'Spanish', 'French'],
    rating: 4.6,
    reviewCount: 112,
  },
  {
    id: 16953,
    name: 'Madrid Dental Emergency Center',
    category: 'Dentists',
    city: 'Madrid',
    address: 'Paseo de la Castellana, 120, 28046 Madrid',
    phone: '+34 915 678 901',
    email: 'info@madriddentalemergency.com',
    website: 'https://www.madriddentalemergency.com',
    description: 'Specialized emergency dental center in Madrid CBD. Immediate appointments for dental emergencies including knocked-out teeth, broken crowns, and severe toothaches. English-speaking team with international patient experience.',
    specialties: ['Emergency Dentistry', 'Dental Trauma', 'Crowns', 'Toothaches'],
    languages: ['English', 'Spanish', 'German'],
    rating: 4.8,
    reviewCount: 67,
  },
  {
    id: 16954,
    name: 'The English Dentist Madrid',
    category: 'Dentists',
    city: 'Madrid',
    address: 'Calle de Serrano, 88, 28006 Madrid',
    phone: '+34 914 321 876',
    email: 'appointments@englishdentistmadrid.com',
    website: 'https://www.englishdentistmadrid.com',
    description: 'Native English-speaking dentist in Madrid providing emergency and family dental care. British-trained with 15+ years experience. Emergency same-day appointments. Specializes in treating expats and international patients.',
    specialties: ['Emergency Dentistry', 'Family Dentistry', 'Cosmetic Dentistry', 'Whitening'],
    languages: ['English', 'Spanish'],
    rating: 4.9,
    reviewCount: 143,
  },
