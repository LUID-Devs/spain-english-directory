...
('Terreta Spain', 'Real Estate', 'English-speaking real estate agency serving Madrid and Valencia. Specializes in property purchase, sale, renovation, interior design, and rental management for international buyers and expats. Multilingual team with expat-focused support.', 'Multiple locations - Madrid & Valencia', 'Madrid', 'Madrid', NULL, NULL, 'https://terretaspain.com/en/', true, false, false, false, NOW(), NOW()),

-- Terreta Spain - Valencia
('Terreta Spain', 'Real Estate', 'English-speaking real estate agency serving Madrid and Valencia. Specializes in property purchase, sale, renovation, interior design, and rental management for international buyers and expats. Multilingual team with expat-focused support.', 'Multiple locations - Madrid & Valencia', 'Valencia', 'Valencia', NULL, NULL, 'https://terretaspain.com/en/', true, false, false, false, NOW(), NOW());
