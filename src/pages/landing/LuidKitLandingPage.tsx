...
const LuidKitLandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col" style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#000', color: '#fff' }}>
      {/* Top Navigation */}
      ...
      {/* Hero Section */}
      <div className="flex-1 flex items-center justify-center px-4 pt-14 pb-12 min-h-[500px]">
        <div className="text-center max-w-3xl">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6" style={{ WebkitTextFillColor: 'white' }}>
            LuidKit
          </h1>
