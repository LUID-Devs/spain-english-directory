...
import { Search, Settings, Menu, Moon, Sun, User } from "lucide-react";
    ...
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="relative flex h-min w-[200px]">
          ...
          <input
            className="focus-outline-none w-full rounded border-none bg-gray-100 p-2 pl-8 placeholder-gray-500 focus:border-transparent dark:bg-gray-700 dark:text-white dark:placeholder-white"
            type="search"
            placeholder="Search..."
          />
        </div>
      ...
      <div className="flex items-center">
        ...
        <div className="hidden items-center justify-between md:flex">
          ...
          <button className="hidden rounded bg-blue-400 px-4 py-2 text-xs font-bold text-white hover:bg-blue-500 md:block" onClick={handleSignOut}>Signout</button>
        </div>
      </div>
    </div>
  );
