...
import { Brain, Sparkles, RotateCcw, Info, Code, Zap } from 'lucide-react';
            ...
            <div className="flex items-center justify-between p-4 rounded-lg border bg-muted/50">
              ...
              <ModelSelector 
                ...
                onChange={(model) => {
                  ...
                  if (model !== 'auto') {
                    store.setAutoModeEnabled(false);
                  }
                }}
                showLabel={true}
                size="default"
                disabled={store.autoModeEnabled}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => {
                  store.setAutoModeEnabled(checked);
                  if (checked) {
                    store.setDefaultModel('auto');
                  }
                }}
              />
            </div>
